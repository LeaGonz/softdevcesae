...
//     e.preventDefault(); // evitamos ejecução antes de enviar form
//     var nome = document.getElementById('nomesobrenome').value;
//     alert(`| FIORI DI SICILIA |\n\nAgradecemos o seu contacto ${nome}, responderemos o mais rapidamente possível.`);

//     e.target.reset(); // limpamos form
// });
...
document.getElementById("form").addEventListener('submit', function (e) {
    ...
    modalMessage.innerHTML = `
      <img src="./imagens/logo-fs 1.png" alt="Logo Fiori di Sicilia" style="width: 100px; margin-bottom: 20px;">
    <br><br>Agradecemos o seu contacto, <strong>${nome.toUpperCase()}</strong>. Responderemos o mais rapidamente possível.`;
