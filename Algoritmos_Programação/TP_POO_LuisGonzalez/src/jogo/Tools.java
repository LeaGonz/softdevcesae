...
public class Tools {
    ...
    public static void pausar() {
        ...
        System.out.print(color.BLUE + "﹏﹏﹏﹏﹏﹏﹏﹏﹏" + color.YELLOW + "\uD80C\uDE9D" + color.BLUE + "﹏﹏﹏﹏﹏﹏﹏﹏﹏" + color.WHITE + " Pressione ENTER para continuar " + color.BLUE + "﹏﹏﹏﹏﹏﹏﹏﹏﹏" + color.YELLOW + "\uD80C\uDE9D" + color.BLUE + "﹏﹏﹏﹏﹏﹏﹏﹏﹏" + color.RESET);
        scanner.nextLine();
    }
