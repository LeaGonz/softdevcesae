        ...
        do {
            ...
            switch (menuOption) {
                ...
                case 3: // Best Sale (By Units)
                    Sale bestSale = this.adminController.getBestSaleUnit();
                    System.out.println("\n*** Best Sale by units ***");
                    System.out.println("Category: " + bestSale.getCategory());
                    System.out.println("Product: " + bestSale.getProduct());
                    System.out.println("Units: " + bestSale.getUnitsSold());
                    System.out.println("Price: " + bestSale.getUnitPrice());
                    break;
